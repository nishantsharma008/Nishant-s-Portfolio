...
export default function IcisftResearchPage() {
  ...
  return (
    <main className="bg-[#0B0F1A] text-white min-h-screen relative overflow-x-hidden font-sans">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] rounded-full opacity-15 bg-blue-600/40 blur-3xl" />
      ...
      <section className="relative max-w-6xl mx-auto px-6 pt-32 pb-20 z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 mb-6">
          <FaAward className="text-cyan-300 text-base animate-pulse" />
          <span className="text-cyan-300 text-sm font-medium tracking-wider uppercase">Published Research</span>
        </div>

        {/* Title */}
        <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
          ICISFT Rayat Bahra Research Paper 2026
        </h1>
        ...
        <p className="text-gray-300 text-lg leading-relaxed mb-10 max-w-3xl">
          Published research paper at International Conference on Information Systems & Future Technology, presenting innovative solutions in modern web development.
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              <h3 className="text-lg font-bold text-cyan-300 mb-4">Topics Covered</h3>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-cyan-500/10 border border-cyan-500/30 rounded-lg text-sm text-cyan-200">Research</span>
                <span className="px-3 py-1.5 bg-cyan-500/10 border border-cyan-500/30 rounded-lg text-sm text-cyan-200">Web Development</span>
                <span className="px-3 py-1.5 bg-cyan-500/10 border border-cyan-500/30 rounded-lg text-sm text-cyan-200">Academic</span>
              </div>
            </div>

            {/* Publication Details */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              <h3 className="text-lg font-bold text-blue-300 mb-4">Publication Details</h3>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Paper ID</span>
                  <span className="text-white font-mono">ICISFT-RB-2026</span>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-white">Rayat Bahra University</span>
                </div>
              </div>
            </div>
