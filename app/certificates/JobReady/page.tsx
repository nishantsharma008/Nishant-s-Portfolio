...
export default function JobReadyEmployabilityPage() {
  ...
  return (
    <main className="bg-[#0B0F1A] text-white min-h-screen relative overflow-x-hidden font-sans">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] rounded-full opacity-15 bg-pink-600/40 blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] rounded-full opacity-15 bg-rose-600/30 blur-3xl" />
      </div>

      {/* ✨ NAVBAR - SAME MODERN STYLE AS INTERFULLSTACK & OTHERS! */}
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#0B0F1A]/80 backdrop-blur-2xl border-b border-white/10 shadow-lg shadow-black/20">
        <div className="w-full px-3 sm:px-6 lg:px-8 py-3.5 sm:py-4 flex items-center justify-between">
          ...
          {/* Professional Skills Button - Same Fancy Style - PINK THEME! */}
          <button 
            className="
              group relative px-4 py-2 sm:px-6 sm:py-2.5
              bg-gradient-to-br from-pink-600/25 to-rose-600/15
              backdrop-blur-sm
              border border-pink-500/40 
              rounded-xl sm:rounded-2xl
              text-xs sm:text-sm font-semibold text-pink-200
              hover:text-white 
              hover:border-pink-400/70
              hover:shadow-[0_0_25px_rgba(236,72,153,0.5),inset_0_0_20px_rgba(236,72,153,0.1)]
              hover:bg-gradient-to-br hover:from-pink-600/35 hover:to-rose-600/25
              active:scale-95 active:shadow-[0_0_15px_rgba(236,72,153,0.7)]
          ...
          >
            ...
            <span className="absolute inset-0 rounded-xl sm:rounded-2xl bg-pink-500/0 group-hover:bg-pink-500/10 blur-xl transition-all duration-500"></span>
            
            <svg 
              className="relative z-10 w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:animate-pulse drop-shadow-[0_0_6px_rgba(236,72,153,0.8)]" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
            ...
            <span className="relative z-10 hidden xs:inline tracking-wide">Professional Skills</span>
            <span className="relative z-10 xs:hidden">Skills</span>
            
            <span className="absolute top-0 left-0 w-2 h-2 border-t-2 border-l-2 border-pink-400/0 group-hover:border-pink-400/80 rounded-tl-lg transition-all duration-300"></span>
            <span className="absolute bottom-0 right-0 w-2 h-2 border-b-2 border-r-2 border-pink-400/0 group-hover:border-pink-400/80 rounded-br-lg transition-all delay-100 duration-300"></span>
          </button>
          
        </div>
      </nav>

      {/* MAIN CONTENT - ALL ORIGINAL JOBREADY CONTENT PRESERVED! */}
      <section className="relative max-w-6xl mx-auto px-6 pt-32 pb-20 z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-pink-500/10 border border-pink-500/30 mb-6">
          <FaAward className="text-pink-300 text-base animate-pulse" />
          <span className="text-pink-300 text-sm font-medium tracking-wider uppercase">Professional Development</span>
        </div>

        {/* Title - ORIGINAL! */}
        <h1 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
          Certificate of Completion of Employability Skills - JobReady
        </h1>
        ...
        <div className="flex flex-wrap items-center gap-4 mb-8 text-gray-400">
          <span className="flex items-center gap-2">
            ...
            Issued by: <strong className="text-white">Wadhwani Foundation</strong>
          </span>
          <span>|</span>
          <span>Date: <strong className="text-white">2025</strong></span>
        </div>

        {/* Description - ORIGINAL! */}
        <p className="text-gray-300 text-lg leading-relaxed mb-10 max-w-3xl">
          Successfully completed comprehensive employability skills program covering professional communication, workplace ethics, problem-solving strategies, teamwork collaboration, and career readiness for the modern job market.
        </p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="relative group order-2 lg:order-1 lg:col-span-1">
            <div className="absolute -inset-1 bg-gradient-to-r from-pink-500/20 via-rose-500/20 to-fuchsia-500/20 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-5 md:p-6 shadow-2xl">
              ...
              <div 
                className="relative w-full aspect-[1.06/1] rounded-2xl overflow-hidden border-2 border-white/10 group-hover:border-pink-500/50 transition-all cursor-pointer hover:scale-[1.02] bg-white"
                onClick={() => setIsImageModalOpen(true)}
              >
                <Image
                  src="/jobready.jpeg"
                  alt="JobReady Employability Certificate - Wadhwani Foundation"
                  fill
              ...
              <p className="text-center text-xs text-gray-500 mt-4 italic cursor-pointer hover:text-pink-400 transition-colors" onClick={() => setIsImageModalOpen(true)}>
          ...
          <div className="space-y-6 order-1 lg:order-2">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              <h3 className="text-lg font-bold text-pink-300 mb-4">Skills Developed</h3>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Soft Skills</span>
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Communication</span>
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Professional Ethics</span>
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Problem Solving</span>
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Teamwork</span>
                <span className="px-3 py-1.5 bg-pink-500/10 border border-pink-500/30 rounded-lg text-sm text-pink-200">Career Readiness</span>
              </div>
            </div>

            {/* Program Info - ORIGINAL! */}
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6">
              <h3 className="text-lg font-bold text-blue-300 mb-4">Certification Details</h3>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Issuing Organization</span>
                  <span className="text-white">Wadhwani Foundation</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Program Name</span>
                  <span className="text-white">JobReady</span>
                </div>
                <div className="flex justify-between text-sm">
            ...
            <div className="flex flex-col gap-3 w-full">
              ...
              >
                ...
                <span className="absolute inset-0 bg-pink-400/20 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-300"></span>
      ...
      {isImageModalOpen && (
        ...
        >
          ...
          >
            ...
            <div className="absolute -inset-4 bg-gradient-to-r from-pink-500/30 via-rose-500/30 to-fuchsia-500/30 rounded-3xl blur-2xl opacity-75"></div>
            
            <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden max-h-[90vh]">
              <Image
                src="/jobready.jpeg"
                alt="JobReady Employability Certificate (Full Size)"
                width={1200}
                height={900}
